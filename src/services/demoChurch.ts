...
export const DEMO_CHURCH_ID = 'church_demo_betel';
...
export function setupDemoChurch(): Church {
  ...
  const demoData: Church = {
    ...
    loginUser: 'demo',
    loginPassword: 'demo',
    address: 'Av. Menino Marcelo, 3500 - Serraria',
    neighborhood: 'Serraria',
    city: 'Maceió',
    state: 'AL',
    instagram: '@beteldemo',
    phone: '(82) 3333-7777',
    whatsapp: '5582988887777',
    logoUrl: DEMO_LOGO_SVG,
    pastorName: 'Pr. Marcos Aurélio Silveira',
    pastorPhone: '(82) 98888-7777',
    pastorWhatsapp: '5582988887777',
  ...
  const demoChildren: Partial<Child>[] = [
    {
      ...
      guardianPhone: '(82) 99123-4567',
      guardianWhatsapp: '5582991234567',
      notes: 'Sem alergias',
    ...
    },
    {
      ...
      guardianPhone: '(82) 99654-1122',
      guardianWhatsapp: '5582996541122',
    ...
    },
    {
      ...
      guardianPhone: '(82) 99555-3322',
      guardianWhatsapp: '5582995553322',
  ...
  const demoPGs: Partial<SmallGroup>[] = [
    {
      id: 'pg_demo_1',
      churchId: DEMO_CHURCH_ID,
      name: 'PG Conexão Serraria',
      leaderName: 'Carlos Eduardo Oliveira',
      leaderPhone: '(82) 99123-4567',
      address: 'Rua das Palmeiras, 110 - Serraria',
      dayOfWeek: 'Quinta-feira',
      time: '20:00',
      frequency: 'semanal',
      participantsCount: 12,
      description: 'Célula de comunhão e oração para famílias da Serraria.',
      status: 'Ativo',
      participants: []
    },
    {
    ...
    },
    {
      ...
      leaderPhone: '(82) 99888-2233',
      address: 'Av. Jatiúca, 450 - Jatiúca',
